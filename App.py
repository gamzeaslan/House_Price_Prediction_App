...
def main():
    ...
    YearBuilt=(st.number_input("YearBuilt", min_value=1870, max_value=2022, value=2020, step=50))
    YearRemodAdd=(st.number_input("YearRemodAdd", min_value=1870, max_value=2022, value=2020, step=1))
